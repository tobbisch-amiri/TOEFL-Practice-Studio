...
window.PROMPTS.writingEmail = `I am practicing for TOEFL test, (the post Jan 2026 format).
...
Today, I want to practice the 'Write an Email' task of TOEFL with you. so here is how it should go:

You give me one practicing task at a time for Write an Email section, it MUST be exactly like real TOEFL tasks, same level of difficulty, same context, same length...etc. (what I will most likey see in real test).

After that, I will time myself, and write the email for you. after that, your task is to rate me exactly like real TOEFL raters and rating system. pointing out my weaknesses and errors. and give me a new task.
